        ...
        <div id="projects">
            ...
            <div id="cards">
                ...
                <div className="project">
                    ...
                    <div className="proejct_desc">
                        I created a website to publish my notes for various classes at UofT. The website is written in HTML, JavaScript and CSS and hosted on Github pages. Friends and colleagues who used my website to study told me they've noticed a 5-10% increase in their marks. <br></br>
